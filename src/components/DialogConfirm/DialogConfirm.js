...
const DialogConfirm = (props) => {
  ...
  const { open, className, message, handleClose, handleConfirm, isConfirm, ...rest } = props;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={isConfirm ? classes.titleConfirm : classes.titleWarning}>
        ...
        >
          ...
          <Button 
            autoFocus
            className={isConfirm ? classes.warningConfirmBtn : classes.submitBtn}
            color="primary"
